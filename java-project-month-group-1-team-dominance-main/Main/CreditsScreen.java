...
public class CreditsScreen extends JPanel {
    ...
    private JPanel creditsMenuPanel; // menu where game resides
    private JPanel creditsScreenPanel;
    ...
    public void initialize() {
            ...
            //-------------------- GAME MENU PANEL -------------//
            creditsMenuPanel = new JPanel(); // initialize the panel so it can be seen
            creditsScreenPanel = new JPanel(new BorderLayout());
            creditsMenuPanel.setLayout(new BoxLayout(creditsMenuPanel, BoxLayout.Y_AXIS));
            creditsMenuPanel.setBorder(BorderFactory.createEmptyBorder(5, 5, 5, 5)); // Width | Right | Height | Left
            // gameMenuPanel.setOpaque(false); // Need for the background to be seen
            creditsMenuPanel.setBackground(Color.YELLOW); // remove if background is set up
            ...
            creditsScreenPanel.setBackground(Color.WHITE);
            creditsScreenPanel.setFocusable(true);
            // creditsScreenPanel.addKeyListener((KeyListener) this); // add key listener only to the GamePanel
            ...
            gameFrame.add(creditsScreenPanel, BorderLayout.CENTER);
...
//------------ Connect Main_Screen to Credits_Screen -------------//
    ...
    public void setVisible(boolean b) {
        ...
        SwingUtilities.invokeLater(() -> creditsScreenPanel.requestFocusInWindow());
